    ...
    if(this.state.amazon_url === "") {
      return (
        <div className="noCamData">
          Sorry, we don't have any data for this camera yet. You can check it out
          <a href={"https://www.amazon.com/s/ref=nb_sb_noss_2?url=search-alias%3Daps&field-keywords=" + this.state.name}>
            {' '}on Amazon
          </a>!
        </div>
      );
